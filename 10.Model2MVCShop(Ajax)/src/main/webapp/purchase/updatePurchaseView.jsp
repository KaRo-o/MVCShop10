	...
	<tr>
		...
		<td class="ct_write01">
			<select 	name="paymentOption" 	class="ct_input_g" style="width: 100px; height: 19px" 
							maxLength="20">
				<option value="1" selected="<c:if test='${purchase.paymentOption.trim().equals("1")}'>selected</c:if>">현금구매</option>
				<option value="2" selected="<c:if test='${purchase.paymentOption.trim().equals("2")}'>selected</c:if>">신용구매</option>
			</select>
		</td>
	</tr>
	<tr>
